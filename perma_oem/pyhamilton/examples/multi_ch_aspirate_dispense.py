...
if __name__ == '__main__':
    ...
    well_labware_pos_2 = ';'.join((plate.layout_name() + ', ' + plate.position_id(well_no) for well_no in range(16+16, 24+16))) # column 3
    ...
    with HamiltonInterface(simulate=True) as hammy:
        ...
        ids = [hammy.send_command(PICKUP, labwarePositions=tip_labware_pos),
               ...
               hammy.send_command(DISPENSE, labwarePositions=well_labware_pos_2, volumes=100.0, liquidClass=liq_class),
